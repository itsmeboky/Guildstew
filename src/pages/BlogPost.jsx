        ...
        <div className="relative">
          ...
          {decorativeImage && (
            <img
              ...
              alt=""
              aria-hidden="true"
              className="hidden md:block pointer-events-none absolute -bottom-10 -right-10 w-44 h-44 lg:w-56 lg:h-56 object-contain z-10 drop-shadow-[0_12px_30px_rgba(0,0,0,0.6)]"
            />
          )}
        </div>
