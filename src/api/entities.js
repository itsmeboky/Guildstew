...
export const entities = {
  ...
  TicketResponse:       createEntity('ticket_messages'),
  TicketMessage:        createEntity('ticket_messages'),
  FAQEntry:             createEntity('faq_entries'),
  DocumentationPage:    createEntity('documentation_pages'),
