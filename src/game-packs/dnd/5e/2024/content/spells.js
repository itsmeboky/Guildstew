...
// spell-overrides.json stays in data/games/dnd5e_2024/ (it's imported directly
// by spells.test.js and JSON can't be re-exported via a shim). TEMPORARY
// cross-ref borrow — resolved when the tests are cut over (Phase 1).
import overrides from "../../../../../data/games/dnd5e_2024/spell-overrides.json" with { type: "json" };
