...
// CASCADE (chunk 2g, Option 1): canEquipToSlot lives in the shared
// game-packs/dnd5e/content/items, not yet duplicated into the leaf — left as
// @/ (transitional borrow) until a later chunk folds content/items in.
import { canEquipToSlot } from '@/game-packs/dnd5e/content/items';
import { itemIcons } from '../itemData.js';
