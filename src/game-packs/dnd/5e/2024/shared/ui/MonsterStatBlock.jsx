...
// TRANSITIONAL shim-borrow (chunk 2g): the 2024 leaf has no dnd5eRules post-2e,
// so this copy reaches the shared vocab via the components/dnd5e shim. Resolved
// by the vocab carve / Brewery phase.
import { abilityModifier } from '../../../../../../components/dnd5e/dnd5eRules.js';
import {
...
import { computeArmorClass } from '../armorClass.js';
// CASCADE (chunk 2g, Option 1): SectionCard + collectFightingStyles live in the
// GMPanel page (which imports this component back — circular). Left as @/ until
// the GMPanel/MonsterStatBlock entanglement is resolved in Phase 1.
