...
const CLASSES = [
  {
    id: 'barbarian', name: 'Barbarian', icon: '🪓', color: '#E74C3C',
  ...
  {
    id: 'bard', name: 'Bard', icon: '🎵', color: '#F39C12',
  ...
  {
    id: 'cleric', name: 'Cleric', icon: '✚', color: '#F1C40F',
  ...
  {
    id: 'druid', name: 'Druid', icon: '🌿', color: '#27AE60',
  ...
  {
    id: 'fighter', name: 'Fighter', icon: '⚔️', color: '#BDC3C7',
  ...
  {
    id: 'monk', name: 'Monk', icon: '👊', color: '#E67E22',
  ...
  {
    id: 'paladin', name: 'Paladin', icon: '🛡️', color: '#3498DB',
  ...
  {
    id: 'ranger', name: 'Ranger', icon: '🏹', color: '#16A085',
  ...
  {
    id: 'rogue', name: 'Rogue', icon: '🗡️', color: '#9B59B6',
  ...
  {
    id: 'sorcerer', name: 'Sorcerer', icon: '✨', color: '#E91E63',
  ...
  {
    id: 'warlock', name: 'Warlock', icon: '👁️', color: '#8E44AD',
  ...
  {
    id: 'wizard', name: 'Wizard', icon: '📖', color: '#2980B9',
