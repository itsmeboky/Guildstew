...
from (values
  ...
  ('assets', 'Iconography',
     'Some content used in this project is licensed under the Creative Commons Attribution 3.0 License, which allows use and modification of the material as long as proper credit is provided to the original creator. More information is available from Creative Commons.',
     'https://creativecommons.org/licenses/by/3.0/legalcode.en', 'Creative Commons', null, 'salmon', 3),
